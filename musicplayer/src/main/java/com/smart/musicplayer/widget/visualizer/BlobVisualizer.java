...
//                Log.e("lichen","distanceY ："+ distanceY);
            ...
            for (int i = 0; i < firstCP.length; i++) {
                ...
                Log.e("lichen", "firstCP[i]   ：" + firstCP[i].x + "," + firstCP[i].y);
                Log.e("lichen", "secondCP[i]  ：" + secondCP[i].x + "," + secondCP[i].y);
...
//            Log.e("lichen", "mBezierPoints[0]  ：" + mBezierPoints[0].x+","+mBezierPoints[0].y);
//            Log.e("lichen", "mBezierPoints[end]  ：" +  mBezierPoints[firstCP.length - 1].x+","+ mBezierPoints[firstCP.length - 1].y);
...
//            blobPath.cubicTo(firstCP[secondCP.length].x, firstCP[secondCP.length].y,
//                    secondCP[secondCP.length].x, secondCP[secondCP.length].y,
//                    mBezierPoints[0].x, mBezierPoints[0].y);

//            blobPath.lineTo( mBezierPoints[0].x, mBezierPoints[0].y);
//            paint.setColor(Color.WHITE);
//            canvas.drawLine(secondCP[firstCP.length-2].x,firstCP[secondCP.length-2].y,
//                    mBezierPoints[0].x, mBezierPoints[0].y, paint);
